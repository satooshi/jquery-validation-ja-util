...
jQuery.extend(jQuery.validator.messages, {
    ...
    pattern: "不正な形式です。",
    require_from_group: jQuery.format("これらの項目は{0}文字以上で入力してください。"),
    skip_or_fill_minimum: jQuery.format("これらの項目は空欄または{0}文字以上で入力してください。"),
    accept: jQuery.format("有効なmimeタイプのファイルを指定してください。"),
    extension: jQuery.format("有効な拡張子のファイルを指定してください。")
});
